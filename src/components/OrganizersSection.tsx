      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Python Bangladesh is organized by passionate community leaders who are dedicated to 
        ...
        <div className="mt-12 text-center">
          <div className="bg-gradient-to-r from-python-blue/10 to-python-yellow/10 rounded-2xl p-6 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 text-sm">
              Python Bangladesh is always looking for passionate volunteers and community contributors. 
